...
export default function WorldModelContent({ canonicalPath = "/world-model" }: { canonicalPath?: string }) {
  const canonicalUrl = `https://shodh.ai${canonicalPath}`;
  const structuredData = {
    ...worldModelStructuredData,
    url: canonicalUrl,
