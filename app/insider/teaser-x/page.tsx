...
const partners = [
  ["Specialty Chemicals", "Aarti Industries", "Paid NRE deployment. Ingesting proprietary batch-to-continuous flow data to train the core chemical latent space."],
  ["Pharma & Biologics", "Jubilant + Biocon", "Data-for-Compute Joint Venture. Securing first-mover factory data for biologic drug scale-up."],
  ["Batteries", "Tier-1 Battery Supplier", "Data-for-Compute Joint Venture for coating, drying, thermal risk, and yield-critical battery manufacturing data."],
  ["Aerospace", "GE Aerospace", "Strategic NRE pathway for aerospace manufacturing physics, retaining foundational model IP while solving line bottlenecks."],
];
...
function ProductionValleyInfographic() {
  return (
    <section className="relative mx-auto w-full max-w-[1500px] overflow-hidden rounded-[1.4rem] border border-[#0b2338]/10 bg-[#f6f5ef] p-5 shadow-[0_30px_90px_rgba(8,20,33,0.22)] sm:p-6 md:aspect-[16/9] md:min-h-0 md:rounded-[2rem] md:p-0">
      ...
      <div className="relative z-10 mt-4 max-w-none rounded-2xl border border-black/10 bg-white/65 p-4 text-left backdrop-blur-xl md:absolute md:right-[6%] md:top-[50%] md:mt-0 md:max-w-[390px] md:border-0 md:bg-transparent md:p-0 md:text-right md:backdrop-blur-none">
        <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#4b6b00] sm:text-xs">Industrial Deployment</p>
        <h2 className="mt-3 text-2xl font-medium uppercase leading-none tracking-tight text-[#111] sm:text-3xl lg:text-[2.25rem]">Physical production still lags</h2>
        <p className="ml-auto mt-4 max-w-[310px] text-sm font-medium leading-snug text-[#0b2338]/70">Scale-up breaks across batteries, biologics, catalysts, and advanced materials.</p>
      </div>

      <div className="relative z-10 mt-4 w-full rounded-2xl border border-black/10 bg-white/65 p-4 text-center backdrop-blur-xl md:absolute md:left-1/2 md:top-[44%] md:mt-0 md:w-[300px] md:max-w-[24%] md:-translate-x-1/2 md:border-0 md:bg-transparent md:p-0 md:backdrop-blur-none">
        <div className="mx-auto space-y-2 text-sm font-light leading-tight tracking-tight text-black/62">
          <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#4b6b00] sm:text-xs">The Missing Layer</p>
          <p className="font-medium text-[#0b2338]/72">Physics changes across scale, process, and factory conditions.</p>
        </div>
      </div>
...
function WorldFoundationalModelInfographic() {
  const cards = [
    ...
    },
    {
      ...
      tag: "Core bridge",
      copy: "JAX-native LBM and JAX-Brownian engines solve Navier-Stokes turbulence, Cahn-Hilliard phase separation, plus Fick's and Fourier's laws in one latent space.",
    },
    {
      number: "03",
...
function PhysicsAiArchitectureImageInfographic() {
  const cards = [
    {
      number: "01",
      title: "Synthetic JAX Engine",
      tag: "Synthetic JAX engine",
      copy: "We bootstrap the model with proprietary hardware-accelerated simulation, generating millions of pristine extreme-physics tensors across Navier-Stokes and Cahn-Hilliard regimes.",
    ...
    {
      number: "03",
      title: "The 'Trojan Horse' NRE Loop",
      tag: "Trojan Horse NRE loop",
      copy: "Sterile math fails in real factories. Paid NREs ingest messy proprietary sensor data, teaching the Sim-to-Real offset and building an untouchable enablement moat.",
  ...
  return (
    <section className="relative mx-auto w-full max-w-[1500px] overflow-hidden rounded-[1.4rem] border border-black/10 bg-[#f6f5ef] p-5 shadow-[0_30px_90px_rgba(8,20,33,0.22)] sm:p-6 md:aspect-[16/9] md:min-h-0 md:rounded-[2rem] md:p-0">
      ...
      <div className="relative z-10 mx-auto max-w-[860px] text-center md:absolute md:left-1/2 md:top-[5%] md:w-[860px] md:max-w-[76%] md:-translate-x-1/2">
        ...
        <p className="mx-auto mt-4 max-w-[760px] text-base font-bold leading-tight text-black/70 sm:text-lg">NREs are the paid path into proprietary factory data. They turn sterile physics into compounding Sim-to-Real intelligence.</p>
      </div>
  ...
  return (
    <section className="relative mx-auto w-full max-w-[1500px] overflow-hidden rounded-[1.4rem] border border-black/10 bg-[#f6f5ef] p-5 shadow-[0_30px_90px_rgba(8,20,33,0.22)] sm:p-6 md:aspect-[16/9] md:min-h-0 md:rounded-[2rem] md:p-0">
      ...
      <div className="relative z-10 mx-auto mt-6 max-w-[1000px] text-center md:absolute md:bottom-[5%] md:left-1/2 md:mt-0 md:w-[1000px] md:max-w-[86%] md:-translate-x-1/2">
        ...
        <p className="mx-auto mt-3 max-w-[960px] text-base font-black uppercase leading-snug tracking-[0.14em] text-[#0b2338]">We use NREs to conquer these pillars one by one, before merging them into a single unified software API.</p>
      </div>
    </section>
  );
}
  ...
  return (
    <section className="relative mx-auto w-full max-w-[1500px] overflow-hidden rounded-[1.4rem] border border-black/10 bg-[#f6f5ef] p-5 shadow-[0_30px_90px_rgba(8,20,33,0.22)] sm:p-6 md:aspect-[16/9] md:min-h-0 md:rounded-[2rem] md:p-0">
      ...
      <div className="relative z-10 mx-auto max-w-[940px] text-center md:absolute md:left-1/2 md:top-[6%] md:w-[940px] md:max-w-[84%] md:-translate-x-1/2">
        ...
        <p className="mx-auto mt-4 max-w-[780px] text-lg font-semibold leading-tight text-black/64">Executing exclusive Data-for-Compute Joint Ventures. We solve their bottlenecks; we retain 100% of the foundational IP.</p>
      </div>
...
function MonetizationPlanInfographic() {
  const horizons = [
    ["Year 1", "Anchor JVs", "$3.5M NRE cash collected to fund Sim-to-Real data ingestion."],
    ["Year 2", "Domain APIs", "Unlock narrow industrial models for $500k/yr software licenses."],
    ["Year 3", "Universal World Model", "$100M+ ARR platform across physical invention workflows."],
  ];

  return (
    <LightSlideShell eyebrow="Financial Master Plan" title="The 3-Horizon Monetization Plan" subtitle="NRE cash buys the data moat; domain APIs unlock software revenue; the Universal World Model becomes the platform layer." tone="cyan">
      <div className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
        <motion.div variants={fadeInUp} className="grid gap-4">
          {horizons.map(([year, title, copy], index) => (
            <div key={title} className="rounded-2xl border border-[#0b2338]/10 bg-white/75 p-5 shadow-lg backdrop-blur-xl">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <p className="text-xs font-black uppercase tracking-[0.22em] text-[#4b6b00]">{String(index + 1).padStart(2, "0")} / {year}</p>
                <p className="rounded-full border border-[#48cae4]/20 bg-[#48cae4]/10 px-3 py-1 text-xs font-black uppercase tracking-[0.16em] text-[#48cae4]">{title}</p>
              </div>
              <p className="mt-4 text-xl font-black uppercase leading-tight tracking-tight text-[#0b2338] md:text-2xl">{copy}</p>
            </div>
          ))}
        </motion.div>

        <motion.div variants={fadeInUp} className="rounded-2xl border border-[#0b2338]/10 bg-[#f6f5ef]/82 p-6 shadow-lg backdrop-blur-xl">
          <p className="text-xs font-black uppercase tracking-[0.22em] text-[#4b6b00]">Why the $50M-$60M round matters</p>
          <h3 className="mt-3 text-3xl font-black uppercase leading-none tracking-tight text-[#0b2338]">Spend compute once. Sell software repeatedly.</h3>
          <div className="mt-8 space-y-6">
            <div>
              <div className="mb-2 flex items-end justify-between gap-4">
                <p className="text-sm font-black uppercase tracking-[0.16em] text-[#0b2338]/72">Year 1 GPU Burn</p>
                <p className="text-3xl font-black text-[#0b2338]">$25M</p>
              </div>
              <div className="h-14 overflow-hidden rounded-full border border-[#0b2338]/10 bg-white">
                <div className="h-full w-[72%] bg-gradient-to-r from-[#0b2338] to-[#48cae4]" />
              </div>
            </div>
            <div>
              <div className="mb-2 flex items-end justify-between gap-4">
                <p className="text-sm font-black uppercase tracking-[0.16em] text-[#0b2338]/72">Software Gross Margins</p>
                <p className="text-3xl font-black text-[#4b6b00]">95%</p>
              </div>
              <div className="h-14 overflow-hidden rounded-full border border-[#b5ff48]/30 bg-white">
                <div className="h-full w-[95%] bg-gradient-to-r from-[#48cae4] to-[#b5ff48]" />
              </div>
            </div>
          </div>
          <p className="mt-7 text-lg font-semibold leading-relaxed text-[#0b2338]/72">The burn creates proprietary Sim-to-Real infrastructure. The margin profile appears when the trained domains ship as APIs.</p>
        </motion.div>
      </div>
    </LightSlideShell>
  );
...
export default function InsiderTeaserXPage() {
  return (
          ...
          >
            <div className="mt-8 grid gap-3 md:grid-cols-3">
              <motion.div variants={scaleIn} className="rounded-2xl border border-[#0b2338]/10 bg-white/78 p-5 backdrop-blur-xl">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#0b2338]/45">Founder</p>
              ...
              <motion.div variants={scaleIn} className="rounded-2xl border border-[#48cae4]/24 bg-[#e8fbff]/70 p-5 backdrop-blur-xl">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#48cae4]">Breakthrough</p>
                <p className="mt-2 text-lg font-medium leading-snug text-[#0b2338]">Solved multi-physics AI before DeepMind and Microsoft AI4Science.</p>
              </motion.div>
              <motion.div variants={scaleIn} className="rounded-2xl border border-[#b5ff48]/30 bg-[#f4ffe7]/75 p-5 backdrop-blur-xl">
                ...
                <p className="mt-2 text-lg font-medium leading-snug text-[#0b2338]">~1M GPU hours awarded under the IndiaAI Mission.</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
