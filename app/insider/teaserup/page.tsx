...
import { Atom, Beaker, Factory, FlaskConical, Globe2, Sparkles, Zap } from "lucide-react";
...
function ProductionValleyInfographic() {
  return (
    <section className="relative mx-auto min-h-[620px] w-full max-w-[1500px] overflow-hidden rounded-[2rem] border border-[#0b2338]/10 bg-[#f6f5ef] shadow-[0_30px_90px_rgba(8,20,33,0.22)] md:aspect-[16/9] md:min-h-0">
      ...
      <div className="absolute left-[7%] top-[8%] w-[480px] max-w-[78%] text-left md:w-[620px] md:max-w-[48%]">
        <h1 className="text-3xl font-medium uppercase leading-none tracking-tight text-[#111] sm:text-4xl lg:text-5xl">Discovery to Industrial Production</h1>
      ...
      <div className="absolute left-1/2 top-[48%] w-[280px] max-w-[44%] -translate-x-1/2 text-center md:w-[380px] md:max-w-[30%]">
        <div className="mx-auto space-y-2 text-sm font-light leading-tight tracking-tight text-black/62 sm:text-base">
          <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#4b6b00] sm:text-xs">The Disconnect</p>
          <p className="font-medium text-[#0b2338]/72">Models propose discoveries; production lags.</p>
        </div>
      </div>
      ...
      <div className="absolute bottom-[9%] left-1/2 w-[340px] max-w-[72%] -translate-x-1/2 rounded-[1.25rem] border border-black/10 bg-white/68 px-5 py-4 text-center shadow-lg backdrop-blur-xl md:bottom-[16%] md:w-[440px] md:max-w-[36%]">
        <p className="mt-3 text-base font-medium uppercase leading-tight tracking-tight text-[#111] sm:text-lg">To cross the gap between quantum/micro scale and the factory floor costs ~$50 Million &amp; 2.5 Years</p>
        <p className="mt-3 text-xs font-light leading-snug text-black/62 sm:text-sm">Driven by 30+ manual lab iterations at $1.5M+ each.</p>
      </div>
    </section>
  );
}
  ...
  return (
    <section className="relative mx-auto min-h-[620px] w-full max-w-[1500px] overflow-hidden rounded-[2rem] border border-black/10 bg-[#f6f5ef] shadow-[0_30px_90px_rgba(8,20,33,0.22)] md:aspect-[16/9] md:min-h-0">
      ...
      <div className="absolute left-[7%] top-[8%] max-w-[630px]">
        ...
        <h2 className="mt-3 text-4xl font-black uppercase leading-none tracking-tight text-[#0b2338] md:text-5xl">The World Foundational Model</h2>
        <p className="mt-4 max-w-[560px] text-base font-semibold leading-tight text-black/70 md:text-lg">One continous model that learns the thread between disocvery to factory</p>
      </div>
  ...
  const cards = [
    {
      number: "01",
      title: "Data Engine",
      tag: "Physics + process data",
      copy: "Generates massive physics-accurate simulations and learns from real industrial processes.",
      className: "left-[4.5%] top-[22%] w-[32%] text-left",
    },
    {
      number: "02",
      title: "Unified Physics Model",
      tag: "Shared latent space",
      copy: "Compresses complex physics into one shared latent space across domains.",
      className: "left-1/2 bottom-[7%] w-[36%] -translate-x-1/2 text-center",
    },
    {
      number: "03",
      title: "Digital Brain",
      tag: "Partner deployment",
      copy: "Deployed with partners, learns from ground truth, and improves every cycle.",
      className: "right-[4.5%] top-[22%] w-[32%] text-right",
    },
  ];
  ...
  return (
    <section className="relative mx-auto min-h-[620px] w-full max-w-[1500px] overflow-hidden rounded-[2rem] border border-black/10 bg-[#f6f5ef] shadow-[0_30px_90px_rgba(8,20,33,0.22)] md:aspect-[16/9] md:min-h-0">
      ...
      <div className="absolute left-1/2 top-[6%] w-[820px] max-w-[74%] -translate-x-1/2 text-center">
        ...
        <h2 className="mt-3 text-3xl font-black uppercase leading-none tracking-tight text-[#0b2338] sm:text-4xl lg:text-5xl">Closing the Real-to-Sim Gap</h2>
        <p className="mx-auto mt-4 max-w-[760px] text-base font-bold leading-tight text-black/70 sm:text-lg">Our IP is a flywheel that turns physics + real-world data into deployable intelligence.</p>
      </div>
  ...
  return (
    <section className="relative mx-auto min-h-[620px] w-full max-w-[1500px] overflow-hidden rounded-[2rem] border border-black/10 bg-[#f6f5ef] shadow-[0_30px_90px_rgba(8,20,33,0.22)] md:aspect-[16/9] md:min-h-0">
      ...
      <div className="absolute left-1/2 top-[5%] w-[900px] max-w-[82%] -translate-x-1/2 text-center">
        <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#4b6b00]">Industry Deployment Strategy</p>
        <h2 className="text-4xl font-bold uppercase leading-none tracking-tight text-[#0b2338] md:text-5xl">The 25 Billion-Dollar Pillars</h2>
        <p className="mx-auto mt-3 max-w-[920px] text-lg font-light leading-tight text-black/64">One base physics model. Twenty-five industrial problems. One compounding World Model.</p>
      </div>

      <div className="absolute left-1/2 top-[20%] w-[760px] max-w-[72%] -translate-x-1/2 text-center">
        <p className="mx-auto max-w-[760px] text-xl font-semibold leading-tight text-[#0b2338]">Each pillar is a paid deployment; every industry adds new factory physics back into the model.</p>
      </div>

      <div className="absolute left-[6%] top-[69%] grid w-[88%] grid-cols-6 gap-3">
        {[
          ...
          <div key={title} className="flex min-h-[126px] flex-col justify-between rounded-2xl border border-black/10 bg-white/68 px-3 py-4 text-center shadow-sm backdrop-blur-xl">
            <p className="min-h-[34px] text-sm font-bold uppercase leading-tight text-[#0b2338]">{title}</p>
            <p className="text-xs font-light leading-snug text-black/62">{mechanism}</p>
            <p className="min-h-[30px] text-xs font-bold leading-snug text-[#4b6b00]">{unlock}</p>
          </div>
        ))}
      </div>

      <div className="absolute bottom-[4%] left-1/2 w-[900px] max-w-[82%] -translate-x-1/2 text-center">
        <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#4b6b00]">+19 potential pillars</p>
        <p className="mx-auto mt-1 max-w-[820px] text-sm font-semibold leading-snug text-[#0b2338]/68">Semiconductors, advanced manufacturing, metamaterials, tissue engineering, nuclear materials, hypersonic materials, industrial heat flow, and smart manufacturing.</p>
      </div>
    </section>
  );
}
  ...
  return (
    <section className="relative mx-auto min-h-[620px] w-full max-w-[1500px] overflow-hidden rounded-[2rem] border border-black/10 bg-[#f6f5ef] shadow-[0_30px_90px_rgba(8,20,33,0.22)] md:aspect-[16/9] md:min-h-0">
      ...
      <div className="absolute left-1/2 top-[6%] w-[940px] max-w-[84%] -translate-x-1/2 text-center">
        ...
        <h2 className="mt-3 text-4xl font-black uppercase leading-none tracking-tight text-[#0b2338] md:text-5xl">Validated with industrial partners</h2>
        <p className="mx-auto mt-4 max-w-[720px] text-lg font-semibold leading-tight text-black/64">We are validating the Pillars with major industrial partners.</p>
      </div>

      <div className="absolute left-[6%] top-[34%] grid w-[88%] grid-cols-4 gap-4">
        {partners.map(([name, text], index) => (
          <div key={name} className="min-h-[170px] rounded-3xl border border-[#0b2338]/10 bg-white/68 p-5 shadow-[0_22px_70px_rgba(11,35,56,0.1)] backdrop-blur-xl">
            <p className="text-[11px] font-black uppercase tracking-[0.22em] text-[#4b6b00]">{String(index + 1).padStart(2, "0")} / Anchor partner</p>
            <h3 className="mt-3 text-xl font-black uppercase leading-none tracking-tight text-[#0b2338]">{name}</h3>
    ...
    <div className="relative min-h-screen w-full overflow-x-hidden bg-[#f6f5ef] text-[#0b2338] selection:bg-[#48cae4] selection:text-[#081421]">
      ...
      <main id="html-scroll-container" className="pointer-events-none relative z-[2] w-full">
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-10 lg:grid-cols-12">
            <motion.div variants={staggerContainer} className="pointer-events-auto lg:col-span-8">
              ...
              <motion.h1 variants={fadeInUp} className="text-5xl font-black uppercase leading-[1.02] tracking-tight text-[#0b2338] sm:text-7xl md:text-8xl lg:text-9xl">
                The World
                <br />
                <span className="bg-gradient-to-r from-[#0b2338] via-[#48cae4] to-[#4b6b00] bg-clip-text text-transparent">Foundational Model</span>
              </motion.h1>
        ...
        <section className="px-4 pb-20 sm:px-6 md:px-10">
          ...
          >
            <motion.p variants={fadeInUp} className="max-w-5xl text-xl font-semibold leading-relaxed text-[#0b2338]/72 md:text-3xl">
        ...
        <LightSlideShell eyebrow="The End Game" title="Generative Physical IP" tone="cyan">
          <motion.div variants={fadeInUp} className="rounded-2xl border border-[#0b2338]/10 bg-white/75 p-6 shadow-lg backdrop-blur-xl md:p-8">
            ...
            <p className="mt-4 text-gray-700">A user prompts:</p>
            <p className="mt-3 rounded-2xl border border-[#0b2338]/10 bg-[#f6f5ef]/80 p-5 text-xl font-light italic leading-relaxed text-[#0b2338] md:text-3xl">“Design a carbon-negative concrete optimized for Indian climate, local feedstock, low cost, and scalable manufacturing.”</p>
            <p className="mt-6 text-gray-700">The World Model generates:</p>
        ...
        <LightSlideShell eyebrow="Business & Vision" title="The Business & Vision" tone="amber">
          <motion.div variants={fadeInUp} className="rounded-2xl border border-[#b5ff48]/25 bg-[#f4ffe7]/75 p-6 shadow-lg backdrop-blur-xl md:p-8">
            ...
            <p className="mt-4 text-lg leading-relaxed text-gray-700">We begin as enterprise physics AI and expand into the zero-to-billion engine for physical IP.</p>
            <p className="mt-3 text-lg leading-relaxed text-gray-700">Long term, Shodh AI participates in the physical IP layer of the next industrial century through licensing, royalties, joint ventures, and co-development.</p>
            <p className="mt-3 text-lg leading-relaxed text-gray-700">We give companies and nations the ability to imagine, validate, and manufacture.</p>
            <p className="mt-3 text-2xl font-medium leading-snug text-[#0b2338]">Just as LLMs made intelligence programmable, Shodh AI makes physical invention programmable.</p>
          </motion.div>
        </LightSlideShell>
