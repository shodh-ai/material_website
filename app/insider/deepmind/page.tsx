        ...
        <div className="hidden xl:block absolute left-4 top-10 bottom-0 w-56 pointer-events-none 2xl:left-6">
          <nav className="sticky top-28 z-40 flex flex-col gap-5 p-6 rounded-2xl bg-black/40 backdrop-blur-md border border-white/5 pointer-events-auto">
            {[
              ...
              { label: "06 Scale Ask",           href: "#s6", desc: "50B Model, TPU, DeepMind" },
            ].map((item, i) => (
            ...
            <motion.div {...fade} className="rounded-2xl border border-white/8 bg-[#060606] p-8 md:p-12 overflow-hidden relative">
              ...
              <div className="relative h-[650px] w-full max-w-6xl mx-auto border border-white/20 bg-white/[0.05] rounded-xl pl-20 backdrop-blur-sm">
                ...
                <svg className="absolute inset-0 w-full h-full overflow-visible pointer-events-none z-0" style={{left:"5rem",width:"calc(100% - 5rem)"}} preserveAspectRatio="none">
                  <defs>
                    <filter id="ggDM"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
                    <filter id="grDM"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
                  </defs>
                  <path d="M 33.3% 83% L 50% 78% L 66.7% 75% L 75% 72%" fill="none" stroke="#34d399" strokeWidth="4" strokeDasharray="6 6" filter="url(#ggDM)" vectorEffect="non-scaling-stroke" className="opacity-80"/>
                  <path d="M 25% 45% L 50% 40% L 58.3% 42% L 66.7% 35% L 75% 16.6%" fill="none" stroke="#fb7185" strokeWidth="4" strokeDasharray="6 6" filter="url(#grDM)" vectorEffect="non-scaling-stroke" className="opacity-80"/>
                </svg>
              ...
              <div className="rounded-2xl border border-white/8 bg-white/[0.02] p-6">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-64 px-5 py-3 rounded-xl border-2 border-blue-600/60 bg-blue-900/15 text-center">
                    ...
                    <p className="text-white/35 text-[11px] mt-0.5 font-mono">ε · τ · D · L</p>
                  </div>
                  <div className="flex flex-col items-center py-1"><div className="w-px h-4 bg-white/20"/><svg width="10" height="6" viewBox="0 0 10 6"><path d="M0 0L5 6L10 0" fill="rgba(255,255,255,0.25)"/></svg></div>
                  <div className="w-64 px-5 py-3 rounded-xl border-2 border-purple-600/60 bg-purple-900/15 text-center">
                    ...
                    <p className="text-white/35 text-[11px] mt-0.5 font-mono">DFN · V(t) · Q-fade · Z(ω) · SEI</p>
                  </div>
                  <div className="flex flex-col items-center py-1"><div className="w-px h-4 bg-white/20"/><svg width="10" height="6" viewBox="0 0 10 6"><path d="M0 0L5 6L10 0" fill="rgba(255,255,255,0.25)"/></svg></div>
            ...
            <motion.div {...fade} className="mb-10 p-6 rounded-2xl border border-white/8 bg-white/[0.02]">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="w-80 px-5 py-3 rounded-xl border-2 border-green-600/60 bg-green-900/15 text-center">
                  ...
                  <p className="text-white/35 text-[11px] mt-0.5 font-mono">τ_eff · D_eff · wetting fraction → microstructure features</p>
                </div>
                <div className="flex flex-col items-center py-1"><div className="w-px h-4 bg-white/20"/><svg width="10" height="6" viewBox="0 0 10 6"><path d="M0 0L5 6L10 0" fill="rgba(255,255,255,0.25)"/></svg></div>
          ...
          <section id="s6" className="mb-24">
            <motion.div {...fade}>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-8">
                <p className="text-white/35 text-xs uppercase tracking-widest mb-6">Discussion Points for DeepMind / Google Cloud</p>
                <div className="space-y-5">
                  {[
                    { n: "01", text: "Optimizing TPU Pod scaling for heavy 3D tensor workloads." },
                    { n: "02", text: "Pushing jax.sharding limits across multi-node, federated clusters." },
                    { n: "03", text: "Best practices for XLA compiler optimization on highly-coupled PDE neural architectures." },
                    { n: "04", text: "Structuring secure Google Cloud VPC enclaves for our 20% federated edge-deployments." },
                  ].map((pt) => (
