...
export default function GenesisPage() {
  return (
    <main className="min-h-screen w-full relative bg-[#081421] text-[#f0f0ff] font-sans selection:bg-[#48cae4] selection:text-[#081421] overflow-x-hidden">
      {/* Background Image with Darker Overlay for readability */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <Image src="/Frame 626503.png" alt="Background" fill priority className="object-cover opacity-60" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#081421]/80 via-[#081421]/90 to-[#081421]" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="pt-32 md:pt-40 pb-16 px-6 md:px-10 max-w-6xl mx-auto">
        ...
        <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8 md:p-12 mb-24 backdrop-blur-md">
