    ...
    <div className="min-h-screen bg-[#060606] text-white" style={{ cursor: "none" }}>
      ...
      <section className="px-6 py-28 md:py-36 border-b border-white/5">
        <div className="max-w-6xl mx-auto">
          <motion.div {...fade}>
            ...
            <h2 className="text-4xl md:text-7xl font-extralight leading-tight tracking-tight mb-14 max-w-4xl">
            ...
            <p className="text-white/70 font-light text-xl max-w-3xl mb-6">
              AI for Science is split into two layers.
            </p>
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mb-6">
              <div className="space-y-3 bg-black/40 backdrop-blur-sm p-6 rounded-2xl border border-white/10">
                ...
                <p className="text-white/50 font-light text-sm leading-relaxed">The atomic layer - focused on discovery - is currently explored by models like AlphaFold and Isomorphic Labs.</p>
              </div>
            ...
            <div className="border-l-2 border-white/10 pl-6 py-2 mb-16 max-w-3xl">
              <p className="text-white/55 font-light leading-relaxed">Thousands of discovered new enzymes, proteins, molecules, and novel materials already exist - but none of them are easily scalable, mesoscale-producible, or manufacturable at volume.</p>
              <p className="text-white/55 font-light leading-relaxed mt-3">There are constant cancer solutions discovered in labs. <span className="text-white font-normal">None of them convert in the real world.</span></p>
            </div>
          </motion.div>

        {/* Landscape of AI for Science */}
        <motion.div {...fade} className="mb-12 mt-2">
          <p className="text-xs tracking-[0.25em] uppercase text-white/30 mb-4">Landscape of AI for Science</p>
          <p className="text-white/65 font-light text-base max-w-3xl mb-6 leading-relaxed">
            AI for Science is transforming how humans do R&amp;D - accelerating discovery, automating experimentation, mapping the molecular universe. But the commercial manufacturing bottleneck remains entirely untouched. <span className="text-white font-normal">That is the problem Shodh AI is solving.</span>
          </p>
          <div className="inline-flex items-center gap-3 px-4 py-2.5 rounded-xl border border-rose-500/25 bg-rose-950/10">
            <span className="text-rose-300 text-xs font-mono uppercase tracking-widest">The Future</span>
            <span className="w-px h-4 bg-white/15" />
            <span className="text-white font-light text-sm">Inverse Design → Zero-Shot Manufacturing</span>
          </div>
        </motion.div>
        ...
        <div className="relative z-10 hidden lg:grid lg:grid-cols-3 gap-6 mb-8">
          {["01 - Digital Discovery", "02 - Automated Gen AI Labs", "03 - Inverse Design"].map((l, i) => (
        ...
        <div className="relative z-10 grid lg:grid-cols-3 gap-6 mb-10">
          {[
            ...
            {
              num: "02", stage: "Automated Gen AI Labs",
              players: ["Emerald Cloud Lab", "Radical AI", "Lila Sciences"],
              desc: "",
              gap: "Physical proof at milligram scale - not a path to commercial manufacturing.",
              border: "border-white/5", bg: "bg-white/[0.01]", numColor: "text-white/40",
              tagBorder: "border-white/15", tagText: "text-white/70", gapColor: "text-white/60",
            },
            {
              num: "03", stage: "Inverse Design - The Frontier",
              players: ["Shodh AI"],
              desc: "",
              gap: "The only frontier AI physics model making inverse design real at industrial scale.",
            ...
            <motion.div key={i} {...fade} transition={{ delay: i * 0.1 }} className={`rounded-xl border ${s.border} ${s.bg} p-7 md:p-9 flex flex-col`}>
              ...
              {s.desc && <p className="text-white/75 font-light text-sm leading-relaxed mb-4">{s.desc}</p>}
        ...
        <motion.div {...fade} className="mt-8 pt-5 border-t border-white/5">
          <p className="text-white/70 font-light text-base leading-relaxed max-w-3xl">
            Discovery is accelerating. Automated labs are proliferating. The final gap - <span className="text-white font-normal">inverse design at industrial scale</span> - remains unsolved. Every dollar invested in Stage 1 and Stage 2 creates more demand for what comes next. <span className="text-white font-normal">We are the only frontier AI team working on it.</span>
          </p>
        </motion.div>

        {/* Problem Anchor - Biocon */}
        <motion.div {...fade} className="mt-12 p-8 rounded-2xl bg-white/[0.02] border border-white/5">
          <p className="text-white/30 text-xs uppercase tracking-wider mb-6">The Problem, Made Concrete - Biocon</p>
          <p className="text-white font-light text-xl leading-relaxed mb-2">
          ...
          <p className="text-white/40 font-light text-xs italic mb-8">- Kiran Mazumdar-Shaw, Founder &amp; Chairperson, Biocon</p>
          <div className="grid md:grid-cols-3 gap-4">
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
              <p className="text-white/30 text-xs uppercase tracking-wider mb-2">The Bottleneck</p>
              <p className="text-white/55 font-light text-sm leading-relaxed">Legacy batch reactors create fluid dynamics and heat-transfer conditions that destroy enzyme activity at scale.</p>
            </div>
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
              <p className="text-white/30 text-xs uppercase tracking-wider mb-2">The Timeline</p>
              <p className="text-white/55 font-light text-sm leading-relaxed">7 years of physical trial-and-error to solve it. $500M wasted per molecule.</p>
            </div>
            <div className="p-4 rounded-xl bg-red-950/20 border border-red-500/10">
              <p className="text-white/30 text-xs uppercase tracking-wider mb-2">Patent Life Lost</p>
              <p className="text-3xl font-extralight text-red-300">−6.75 <span className="text-lg">yrs</span></p>
              <p className="text-white/35 text-xs mt-1">→ $1.35B in monopoly revenue gone, per molecule</p>
            </div>
          </div>
        </motion.div>
        </div>
      ...
      <section className="px-6 py-28 md:py-36 max-w-6xl mx-auto border-b border-white/5">
        <motion.div {...fade}>
          ...
          <p className="text-white/30 text-xs uppercase tracking-[0.25em] mb-4">The Fourth Industrial Revolution</p>
          <h2 className="text-5xl md:text-8xl font-extralight leading-[0.92] tracking-tight mb-8 max-w-5xl">
            The physical world is<br /><span className="font-normal">the next frontier of AI.</span>
          </h2>
          <p className="text-white/50 font-light text-lg max-w-2xl mb-5 leading-relaxed">
            Steam. Electricity. Computers. Now: <span className="text-white font-normal">manufacturing by design.</span>
          </p>
          <p className="text-white/35 font-light text-base max-w-2xl mb-16 leading-relaxed">
            Nations that control the manufacturing blueprint define the new industrial order. Invention will no longer be luck.
          </p>
        </motion.div>
        ...
        {/* Patent stat */}
        <motion.div {...fade} className="mt-10 pt-8 border-t border-white/5">
          <p className="text-white/30 text-xs uppercase tracking-wider mb-2">Patent Life Recovered Per Engagement</p>
      ...
      <section className="px-6 py-28 md:py-36 max-w-6xl mx-auto border-b border-white/5">
        ...
        <motion.div {...fade} className="mb-16 rounded-2xl border border-white/8 bg-[#060606] p-8 md:p-12 overflow-hidden relative">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-4">
            <div className="p-6 rounded-xl bg-white/[0.02] border border-white/8 space-y-2">
              ...
              <p className="text-white/65 font-light text-sm leading-relaxed">Biology models fold 1D sequences. Physics requires 3D tensors - position, time, temperature, pressure - all at once. Orders of magnitude more complex. Current SOTA: Aurora at 1.3B params. Our target: <span className="text-white font-normal">10B+.</span></p>
            </div>
            <div className="p-6 rounded-xl bg-rose-950/10 border border-rose-500/15 space-y-2">
              <p className="text-rose-300/70 text-xs uppercase tracking-wider">The Physics Advantage</p>
              <p className="text-white/65 font-light text-sm leading-relaxed">Physics has <span className="text-white font-normal">ground truth: 5 governing equations.</span> No clinical trials. No regulatory guesswork. Sim2Real validation in 6 months, not 10 years.</p>
            </div>
        ...
        <motion.div {...fade} className="mb-16">
          <h3 className="text-2xl md:text-4xl font-extralight text-white mb-2 max-w-3xl">Engineering the 10-Billion Parameter SOTA.</h3>
          <p className="text-white/40 font-light text-sm max-w-2xl mb-10">Two stages. Two goals. One architecture.</p>
          ...
          <div className="mb-6 p-8 rounded-2xl border border-blue-500/20 bg-blue-950/10">
            <div className="mb-5">
              ...
              <h4 className="text-white font-light text-2xl">10B Parameter Model</h4>
              <p className="text-blue-300/50 text-xs mt-1">Domain-Specific Interpolation</p>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3 text-white/55 font-light text-sm leading-relaxed">
                <p>Targeted at porous media physics. Constrained to the specific process distributions of our anchor partners - Biocon bioreactors, Jubilant flow chemistry, Aarti batch reactions.</p>
                <p>Fine-tuned on their historical failure data via federated deployment. Hits <span className="text-white font-normal">90% accuracy</span> on their specific distributions.</p>
                <p className="text-white/30 font-mono text-xs">JAX/FLAX · FNO/UPT compression · Mixture of Experts routing</p>
              </div>
              <div className="space-y-3">
                <div className="p-4 rounded-xl bg-white/[0.03] border border-white/8">
                  <p className="text-white/35 text-xs uppercase tracking-wider mb-2">What this stage proves</p>
                  <ul className="space-y-1.5 text-white/55 font-light text-sm">
                    <li className="flex items-start gap-2"><span className="text-blue-300/60">→</span> Architecture works: JAX, MoE, FNO/UPT compression</li>
                    <li className="flex items-start gap-2"><span className="text-blue-300/60">→</span> Unit economics work: trigger the first 3 × $10M NRE bounties</li>
                    <li className="flex items-start gap-2"><span className="text-blue-300/60">→</span> Sim-to-Real loop closes at commercial accuracy</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="p-8 rounded-2xl border border-rose-500/20 bg-rose-950/10">
            <div className="mb-5">
              ...
              <h4 className="text-white font-light text-2xl">100B+ Parameter Model</h4>
              <p className="text-rose-300/50 text-xs mt-1">Universal Zero-Shot Extrapolation</p>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3 text-white/55 font-light text-sm leading-relaxed">
                <p>A client brings a completely novel molecule or aerospace composite never before seen. The LPM outputs the gigafactory blueprint. No historical fine-tuning required.</p>
                <p>The first 90% of physics - laminar flow, basic heat transfer - is solvable at 10B. The last 9.99% is chaotic and non-linear: <span className="text-white font-normal">turbulence, multi-phase boundary fractures, electromagnetic interference.</span></p>
                <p className="text-white/35">Simulating turbulence at the mesoscale without hallucinating requires exponential parameter increases and massive synthetic DNS data.</p>
              </div>
              <div className="space-y-3">
                <div className="p-4 rounded-xl bg-white/[0.03] border border-white/8">
                  <p className="text-white/35 text-xs uppercase tracking-wider mb-2">Expansion after 10B proof</p>
                  <ul className="space-y-1.5 text-white/55 font-light text-sm">
                ...
                <div className="p-4 rounded-xl bg-rose-950/20 border border-rose-500/10">
                  <p className="text-white/35 text-xs uppercase tracking-wider mb-1">What it requires</p>
                  <p className="text-white/50 font-light text-sm">100B+ MoE architecture. Scale-up in sovereign compute. Mastering the chaotic edge cases of physics no existing model has touched.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* ─── PROOF: OUR "ALPHAFOLD" MOMENT ─── */}
      <section className="px-6 py-28 md:py-36 max-w-6xl mx-auto border-b border-white/5">
        <motion.div {...fade}>
          <div className="flex items-center gap-4 mb-10">
            <div className="h-px w-8 bg-white/15 shrink-0" />
            <p className="text-xs uppercase tracking-[0.25em] text-white/55">Early Work - Demo Proof</p>
          </div>
          <h2 className="text-4xl md:text-6xl font-extralight leading-tight tracking-tight mb-6 max-w-3xl">
            The Proof: Our<br /><span className="font-normal">&ldquo;AlphaFold&rdquo; Moment.</span>
          </h2>
          <p className="text-white/55 font-light text-lg max-w-2xl mb-4 leading-relaxed">
            At the recent Global AI Summit, we unveiled our V0 foundational physics engine: a highly compressed, <span className="text-white font-normal">300-Million parameter model.</span>
          </p>
          <p className="text-white/40 font-light text-base max-w-2xl mb-16 leading-relaxed">
            To validate it, we didn&apos;t use clean datasets. We ran a 25-day blind Sim2Real sprint on one of the most chaotic multiphysics environments in the world: <span className="text-white/60 font-normal">Solid-State Batteries.</span>
          </p>
        </motion.div>

        {/* Part 1: Synthetic Data Engine */}
        <motion.div {...fade} className="mb-16">
          <div className="flex items-center gap-3 mb-2">
            <span className="text-white/25 font-mono text-sm">1.</span>
            <h3 className="text-xl md:text-2xl font-light text-white">The Synthetic Data Engine: 95% Morphological Accuracy</h3>
          </div>
          <p className="text-white/35 font-light text-sm mb-6 max-w-2xl">The bottleneck in physical AI is the lack of 3D training data. We algorithmically generate our own.</p>
          <p className="text-white/55 font-light text-base max-w-3xl mb-10 leading-relaxed">
            Our AI algorithmically generated thousands of synthetic 3D microstructures. Cross-referenced against real-world Scanning Electron Microscope (SEM) data, our synthetic topologies achieved a <span className="text-white font-normal">95% morphological match to physical reality.</span> We generate the physical training ground in milliseconds.
          </p>
        ...
        <motion.div {...fade} className="mb-10 border-t border-white/5 pt-12">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-xl md:text-2xl font-light text-white">The 25-Day Blind Sim2Real Sprint</h3>
          </div>
          <p className="text-white/35 font-light text-sm mb-10 max-w-2xl">We put the 300M parameter model to the ultimate test. Zero historical data. 5 unique battery architectures generated, built, and validated.</p>
        </motion.div>
        ...
        <div className="p-8 rounded-xl bg-gradient-to-r from-blue-900/20 via-purple-900/20 to-emerald-900/20 border border-white/10 mb-0">
          <p className="text-white/35 text-xs uppercase tracking-wider mb-4">The Scaling Law Guarantee - Why we need $50M</p>
          <p className="text-lg md:text-xl text-white font-light leading-relaxed max-w-4xl">
            70% zero-shot accuracy from a 300M parameter model is a <span className="font-medium">scientific breakthrough.</span> It proves the foundational neural architecture works.
          </p>
          <p className="text-white/55 font-light text-base max-w-4xl mt-4 leading-relaxed">
            Applying standard AI scaling laws: 300M → 10B parameters (powered by our secured sovereign GPU compute) mathematically bridges from 70% lab accuracy to <span className="text-white font-normal">99.9% commercial factory accuracy.</span>
          </p>
        </div>
      ...
      <section className="px-6 py-28 md:py-36 max-w-6xl mx-auto border-b border-white/5">
        ...
        <motion.div {...fade} transition={{ delay: 0.3 }} className="p-6 md:p-8 rounded-2xl bg-white/[0.02] border border-white/5">
