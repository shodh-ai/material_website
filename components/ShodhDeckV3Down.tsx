    ...
    <div className="min-h-screen bg-[#060606] text-white" style={{ cursor: "none" }}>
      ...
      <section className="px-6 py-28 md:py-36 border-b border-white/5">
        ...
        <motion.div {...fade} className="mt-8 pt-5 border-t border-white/5">
          <p className="text-white/30 font-light text-xs leading-relaxed max-w-3xl">
            Isomorphic and Radical AI are our upstream — they hand us the molecule, we build the factory. Every dollar invested in Stage 1 and Stage 2 creates more demand for Stage 3. <span className="text-white/45">We are the only team working on it.</span>
          </p>
        </motion.div>
        </div>
      </section>
      ...
      <section className="px-6 py-28 md:py-36 max-w-6xl mx-auto border-b border-white/5">
        ...
        {/* Impact for Anchor Partners */}
        <motion.div {...fade} className="mt-10 p-8 md:p-10 rounded-2xl bg-emerald-950/20 border border-emerald-500/20">
          <p className="text-white/35 text-xs uppercase tracking-wider mb-6">Impact for Our Anchor Partners — Biocon</p>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <p className="text-white font-light text-lg leading-relaxed">
                “We have novel biocatalysts that can cut our 16-step API synthesis to 3 steps. But when we scale to an industrial reactor, the enzyme dies.”
              </p>
              <p className="text-white/40 font-light text-xs italic">— Kiran Mazumdar-Shaw, Founder, Biocon</p>
              <div className="pt-4 border-t border-white/5 space-y-2 text-white/55 font-light text-sm leading-relaxed">
                <p>Legacy batch reactors create fluid dynamics and heat transfer conditions that destroy enzyme activity at scale. 7 years of physical trial-and-error to solve it. $500M wasted per molecule.</p>
                <p className="text-white/70">Shodh AI designs the exact continuous-flow architecture — reactor geometry, flow rate, thermal profile — for each enzyme. First try.</p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="p-5 rounded-xl bg-white/[0.03] border border-white/8">
                <p className="text-white/35 text-xs uppercase tracking-wider mb-3">The Value Delivered</p>
                <ul className="space-y-2 text-white/60 font-light text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-400 mt-0.5">&#x2192;</span> 16-step batch process compressed to 3-step continuous flow</li>
                  <li className="flex items-start gap-2"><span className="text-emerald-400 mt-0.5">&#x2192;</span> 7 years of scale-up engineering compressed to 6 months</li>
                  <li className="flex items-start gap-2"><span className="text-emerald-400 mt-0.5">&#x2192;</span> Kiran is co-creating with us. Syngene wet-labs available for our physical compiler loop.</li>
                </ul>
              </div>
              <div className="p-5 rounded-xl bg-emerald-950/30 border border-emerald-500/15">
                ...
                <p className="text-white/40 font-light text-xs mt-1">Patents last 20 years. At $200M/yr → <span className="text-emerald-300/70 font-normal">$1.35B in monopoly revenue</span> per engagement</p>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <section className="px-6 py-28 md:py-36 max-w-6xl mx-auto border-b border-white/5">
        ...
        <motion.div {...fade} className="mb-16 rounded-2xl border border-white/8 bg-[#060606] p-8 md:p-12 overflow-hidden relative">
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-4">
            <div className="p-6 rounded-xl bg-white/[0.02] border border-white/8 space-y-3">
              <p className="text-rose-300/70 text-xs uppercase tracking-wider">Why 3D Physics Is Harder Than 1D Biology</p>
              <p className="text-white/65 font-light text-sm leading-relaxed">Protein folding operates in 1D sequence space. Physics operates in 3D tensor space — X, Y, Z, Time, Temperature, Pressure, Chemical Concentration — simultaneously. The computational complexity is orders of magnitude higher.</p>
              <p className="text-white/45 font-light text-sm leading-relaxed">Current SOTA in 3D physical models: Aurora at 1.3B parameters. Our target: <span className="text-white font-normal">10B+.</span></p>
            </div>
            <div className="p-6 rounded-xl bg-rose-950/10 border border-rose-500/15 space-y-3">
              <p className="text-rose-300/70 text-xs uppercase tracking-wider">The Physics Advantage</p>
              <p className="text-white/65 font-light text-sm leading-relaxed">Unlike biology models, physics has <span className="text-white font-normal">ground truth — the 5 governing equations.</span> Our model is bound by deterministic laws. This gives us higher Sim2Real accuracy and a time-to-value of 6 months, not 10 years. No clinical trials. No regulatory guesswork.</p>
            </div>
          </div>
          <div className="mt-4 p-6 rounded-xl bg-white/[0.015] border border-white/5">
            <p className="text-white/40 text-xs uppercase tracking-wider mb-2">Reading the Graph</p>
            <p className="text-white/55 font-light text-sm leading-relaxed">FNO (Fourier Neural Operator) was the inflection point for 3D physics — proving AI can solve PDEs. Since then, UPT and other scalable architectures have emerged. The 3D track is now accelerating. We are building our own architecture from scratch, trained on sovereign GPU allocation, with direct collaboration from <span className="text-white font-normal">Google’s JAX team</span> and <span className="text-white font-normal">NVIDIA Physics NeMo.</span></p>
          </div>
        </motion.div>
