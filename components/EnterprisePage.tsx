      ...
      <main className="max-w-5xl mx-auto px-6 py-20 space-y-32">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-light tracking-tight leading-tight mb-6">
            The Generative Physics Engine to <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400">
              Scale R&D Flawlessly.
            </span>
          </h1>
        ...
        <motion.section 
          ...
          className="text-center space-y-8"
        >
          <span className="text-xs font-light tracking-[0.2em] uppercase text-emerald-400 block">The Value</span>
          <h2 className="text-3xl md:text-5xl font-light text-white mb-8">Shrinking Your Factories. Maximizing Your Yield.</h2>
          
          <div className="p-8 rounded-2xl bg-white/[0.02] border border-white/5 max-w-3xl mx-auto text-left mb-8 relative">
            <div className="absolute top-4 right-4 bg-yellow-500/10 border border-yellow-500/30 text-yellow-300/80 text-[10px] px-2 py-1 rounded uppercase tracking-widest">
              Prompt Context (Delete Unused)
            </div>
            <p className="text-white/50 text-sm mb-4 font-light italic">Universal physics scales to your bottlenecks:</p>
            ...
            <ul className="space-y-6">
              <li className="flex gap-4 items-start">
                ...
                <div>
                  <h4 className="text-white font-medium mb-1">Pharma & Chemicals <span className="text-white/40 font-light text-sm">(Batch-to-Continuous)</span></h4>
                  <p className="text-white/70 font-light text-sm">Swap massive $500M batch plants for predictable $5M "Suitcase Factories."</p>
                </div>
              </li>
              <li className="flex gap-4 items-start">
                ...
                <div>
                  <h4 className="text-white font-medium mb-1">Energy & EV <span className="text-white/40 font-light text-sm">(Battery Scale-Up)</span></h4>
                  <p className="text-white/70 font-light text-sm">Design crack-proof anodes and accelerate solid-state R&D by years.</p>
                </div>
              </li>
              <li className="flex gap-4 items-start">
                ...
                <div>
                  <h4 className="text-white font-medium mb-1">Tech & Semiconductors <span className="text-white/40 font-light text-sm">(Thermal Mastery)</span></h4>
                  <p className="text-white/70 font-light text-sm">Embed generative cooling channels directly into chips to prevent thermal meltdown.</p>
                </div>
              </li>
            </ul>
          </div>
