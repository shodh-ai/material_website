      ...
      <main className="max-w-5xl mx-auto px-6 py-20 space-y-32">
        ...
        >
          ...
          <div className="mb-16 relative z-10 space-y-6">
            <span className="text-xs font-light tracking-[0.2em] uppercase text-purple-400 block">1. About Shodh AI</span>
          ...
          <div className="relative z-10 pt-12 border-t border-white/10">
            <h3 className="text-2xl font-light text-white leading-tight mb-8">
              AI Conquered Language. Then Discovery. <span className="text-purple-400 font-medium">Now, Manufacturing.</span>
            </h3>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-6 items-start p-6 -mx-6 rounded-2xl bg-purple-500/5 border border-purple-500/20">
                <div className="w-10 h-10 rounded-full bg-purple-500/20 text-purple-400 flex items-center justify-center shrink-0 font-medium">3</div>
                <div>
        ...
        >
          ...
          <div className="pt-16 border-t border-white/10 max-w-3xl mx-auto text-left flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <div className="flex flex-col md:items-end gap-4">
              <a href="mailto:arastu@shodh.ai" className="bg-purple-500 hover:bg-purple-400 text-white px-8 py-3 rounded-full font-medium transition-colors inline-flex items-center justify-center gap-2">
                Connect with Founder
              </a>
              <div className="flex flex-col md:items-end gap-2 text-sm">
                <a href="mailto:arastu@shodh.ai" className="text-purple-400 hover:text-purple-300 transition-colors">arastu@shodh.ai</a>
